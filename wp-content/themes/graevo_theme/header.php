...
<html <?php language_attributes(); ?> class="no-js" prefix="og: http://ogp.me/ns#">
	<head>
        ...
        <meta name="google-site-verification" content="W88_n4DbDXMrmIsjuYdFjHe-pPKMwySTs1mkrK8LkX4" />

		<!-- Fonts -->
		<link rel="preconnect" href="https://fonts.gstatic.com">
		<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">

        <?php if(is_page_template('templates/template-stoke.php')): ?>
	...
	<header id="header" class="header clear d-flex align-items-center justify-content-center" role="banner">
		<div class="container-fluid">
			<div class="row py-3 py-md-4 main-header">


				<div class="header-logo col-6 col-lg-2 col-xl2-2  d-flex align-items-center justify-content-start order-1 order-lg-1">
				...
				<div class="col-12 col-lg-8 col-xl2-6 d-flex align-items-center justify-content-center order-3 order-lg-2 mt-3 mt-lg-0">
                    <div class="nav w-100  align-items-center justify-content-between d-none d-xl-flex"
                         role="navigation">
                        <?php
                        theme_nav();
                        ?>
				...
				<div class="header-account col-6 col-lg-2 col-xl2-4 d-flex align-items-center  order-2 order-lg-3">
					<nav class="icons-menu d-flex w-100 mr-3 justify-content-end justify-content-xl-between">
                        <div class="icons-menu--item mx-2 mx-md-2 d-flex align-items-center  justify-content-center">
                            <a href="<?php echo tel_href( $phone_number ) ?>"
                               title="<?php _e('Телефон','html5blank'); ?>"
                               class=" d-flex align-items-center font-weight-bold justify-content-center">
                                <?php echo $SVG['phone_n'] ?>
                                <span class="d-none d-xl2-flex ml-2">  <?php echo $phone_number ?> </span>
                            </a>
                        </div>

                        <div class="icons-menu--item  header-search mx-2 mx-md-3 mt-2 d-flex align-items-center  justify-content-center">
                            <button type="button" class="search-button d-flex align-items-center flex-column justify-content-center ">
                                <div class="icon-search">
                                    <?php echo $SVG['search_ico_n'] ?>
                                </div>
                                <span class="mt-2 d-none d-xl2-flex"><?php _e('Пошук','html5blank'); ?></span>
                            </button>
                            <button type="button" class="search-button-close align-items-center flex-column justify-content-center ">
                                <div class="icon-close">
                                    <?php echo $SVG['close_icon_orange'] ?>
                                </div>
                                <span class="mt-2 d-none d-xl2-flex"><?php _e('Пошук','html5blank'); ?></span>
                            </button>
                        </div>

						<div class="icons-menu--item account mx-2 mx-md-3 mt-2 d-flex align-items-center  justify-content-center">
							<?php
							...
							<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"
							   ...
							   class="d-flex align-items-center flex-column justify-content-center">
								<?php echo $SVG['account_n'] ?>
								<span class=" ml-2 mt-2 d-none d-xl2-flex"> <?php echo $account_text ?> </span>
							</a>
						</div>

						<div class="icons-menu--item cart mx-2 mx-md-3 mt-2 d-flex align-items-center  justify-content-center">
							<a href="<?php echo esc_url( wc_get_cart_url() ); ?>"
							   title="<?php _e('Кошик','html5blank'); ?>"
							   class="d-flex align-items-center flex-column justify-content-center" >
								<?php echo $SVG['cart_n'] ?>
								<div class="ml-2">
									<span class="cart-count d-flex align-items-center text-center font-weight-bold justify-content-center"> <?php echo wc()->cart->get_cart_contents_count(); ?> </span>
									<p class="m-0 mt-2 d-none d-xl2-block"> <span> Cума: </span> <br> <span class="cart-amount font-weight-bold"> <?php echo wc()->cart->get_cart_total(); ?> </span> </p>
								</div>
							</a>
						</div>
                ...
                <div id="header-search-form" class=" col-12 search-form-wrap mx-auto mt-2 order-4">
	...
	<div id="header-menu" style="display: none!important;" class="header clear d-flex align-items-center justify-content-center" role="banner">
		<div class="container">
	...
	<div class="mobile-row bg-c_yellow_dark w-100 d-flex d-xl-none align-items-center justify-content-start " >
		<button id="toggle-mobile-menu"
				name="toggle-mobile-menu"
				class="toggle-mobile-menu mx-3 d-xl-none d-flex" type="button" >
